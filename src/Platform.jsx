...
const Trade = ({ coins = COINS, addTradeToast }) => {
  ...
  return (
    <div style={{ display:"grid", gridTemplateColumns:"1fr 260px", gap:14, height:"calc(100vh - 120px)", minHeight:600 }}>
      {/* Chart side */}
    ...
    <CoinsContext.Provider value={coins}>
      <div style={{ display:"flex", minHeight:"100vh", fontFamily:"'Syne',sans-serif", flexDirection:"column" }}>
        ...
        <nav className="bottom-nav">
          {MOBILE_NAV.map(n => (
            <button key={n.id} onClick={()=>nav(n.id)} style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:3, background:"none", border:"none", color:page===n.id?"var(--gold)":"var(--muted)", cursor:"pointer", padding:"4px 8px", fontFamily:"'Syne',sans-serif", minWidth:52 }}>
